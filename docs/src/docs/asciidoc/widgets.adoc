...
|<<boxtext,BoxText>>
|Stateless
|Large 3-row "box" glyph text (A-Z/0-9)
...
Renders large 3-row tall text using box-drawing characters. Unknown characters are rendered as spaces.

[source,java]
----
BoxText box = BoxText.from("TAMBOUI 2026");
box.render(area, buffer);
----
