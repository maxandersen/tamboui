...
|Toolkit DSL element wrapping the markdown renderer
...
* link:markdown.html[Markdown Reference] - Render CommonMark + GFM with the optional `tamboui-markdown` module
...
[NOTE]
====
This page is a pull request documentation preview.
====
