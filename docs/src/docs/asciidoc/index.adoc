...
=== link:layouts.html[Layouts Reference]
Layout widgets for arranging children: Columns, Grid, Dock, Stack, Flow.

=== link:widgets.html[Widgets Reference]
Comprehensive guide to all available widgets with examples.

=== link:flamegraphs.html[Flamegraph Viewer]
How to generate collapsed stacks and visualize flamegraphs.
